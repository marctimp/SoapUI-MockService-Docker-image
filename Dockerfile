...
# Use the latest openjdk 8 base image - MT was unmaintained deprecated openjdk 8
...
RUN curl -LO https://s3.amazonaws.com/downloads.eviware/soapuios/5.7.0/SoapUI-5.7.0-linux-bin.tar.gz && \
    tar -xzf SoapUI-5.7.0-linux-bin.tar.gz -C /home/soapui && \
    rm -f SoapUI-5.7.0-linux-bin.tar.gz MD5SUM
...
ENV SOAPUI_DIR /home/soapui/SoapUI-5.7.0
